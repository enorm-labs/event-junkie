...
| [docs/BACKUPS.md](./docs/BACKUPS.md)                                           | What protects the database, what each layer survives, and how you know it works                                                                                         |
| [docs/RESTORE_RUNBOOK.md](./docs/RESTORE_RUNBOOK.md)                           | Restoring it, written for someone who is reading it because something went wrong                                                                                        |
