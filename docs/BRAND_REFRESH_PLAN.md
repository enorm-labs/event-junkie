...
| Favicon (vector)        | `public/favicon.svg`                         | The small badge, flat, no gradient. **Give it explicit fills** — see the note below; a knockout on a transparent ground disappears on a dark tab strip                                                                                 |
| Favicon (raster)        | `public/favicon.ico`                         | 32 px. Generated from the badge, not drawn                                                                                                                                                                                             |
| iOS home screen         | `public/apple-touch-icon.png`                | 180×180. iOS does not render SVG favicons, which is why this file exists                                                                                                                                                               |
| Social preview (GitHub) | `docs/branding/social-preview.png`           | 1280×640, from the **tagline stamp** — English-only surface, so it takes the richer caption. Uploaded in repository settings; **empty today** ([#477](https://github.com/enorm-labs/event-junkie/issues/477), BRANDING §6a)            |
| Social preview (site)   | `events-frontend/public/og-image.png`        | 1200×630, from the **tagline stamp**, plus the `og:image` / `twitter:image` tags — **neither exists today**, see below. English-only is acceptable here: it is one static file and the `/de` pages carry their own live tagline        |
